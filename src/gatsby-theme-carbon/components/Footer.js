...
const links = {
  firstCol: [
    { href: 'https://ibm.com/design', linkText: 'CloudPak for Application' },
    { href: 'https://ibm.com/design', linkText: 'CloudPak for Automation' },
    { href: 'https://ibm.com/design', linkText: 'CloudPak for Data' },
  ],
  secondCol: [
    { href: 'https://ibm.com/design', linkText: 'CloudPak for Integration' },
    { href: 'https://ibm.com/design', linkText: 'CloudPak for MultiCloud' },
  ],
};
